...
public class DeleteMyAdvertisements {
    ...
    public void BlobToImageTolabeling(int value) {
       ...
       // s.main3();
        ...
        try {
               pst = con.prepareStatement("delete from advertisements where id =?");
   ...
   /* public void show() {    
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            DeleteMyAdvertisements window = new DeleteMyAdvertisements();
    ...
    public void mainShowMyAdvertisements() {
        EventQueue.invokeLater(() -> {
            DeleteMyAdvertisements window = new DeleteMyAdvertisements(email);
            window.frame.setVisible(true);
        });
    }

    public DeleteMyAdvertisements() {
        Connect();
        initialize();
    }
     ...
     */
    public DeleteMyAdvertisements(String email) {
        Connect();
        this.email = email;
    ...
    private void initialize() {
        ...
        btnShow.setBounds(1706, 971, 89, 23);
        ...
        btnNewButton.setBounds(1805, 971, 89, 23);
